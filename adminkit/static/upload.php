                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="letterhead.php"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
...
?>
        <main class="content">
                           <div class="row">
                          <div class="col-lg-12">
                                  <h3 class="text-left">Insert Data</h3>
                      ...
                      <div class="card-body">
                       <input type="text" class="form-control" placeholder="Enter Email" style="margin-bottom: 20px" name="email" id="email" required>
                                       ...
                                       <div class="card-body">
                                           <input type="file" class="form-control" style="margin-bottom: 20px" name="image" required>
                                       </div>
                                  <div class="card-body">
                                          <input type="text" class="form-control" placeholder="Enter Address" style="margin-bottom: 20px" name="address" id="address" required>

                                        <input type="submit" value="+Add data" name="form_submit" class="btn btn-primary">
                                     </div>
