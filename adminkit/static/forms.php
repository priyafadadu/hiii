	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin</span>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Letter-head</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Visiting-card</span>
            </a>
					</li>
					<li class="sidebar-item">
