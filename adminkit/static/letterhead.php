...
<!--                                </div>-->
                                <div class="card-body">
                                    ...
                                    <!--                                <p class="text-center"><a href="add.php" class="btn btn-primary">Add Data</a></p>-->
                                    <input type="submit" value="+Generate" name="create" class="btn btn-success btn-lg btn-block" style="text-align: center">
                                </div>
