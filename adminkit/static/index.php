...
<!--					</li>-->
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <div id="wrap">
                <div class="container">
                    <span style="float:right;"><a href="upload.php"><button class="btn btn-primary">+Add new data </button></a></span>
                            ...
                            echo '
                               <tr>
                                    ...
                                    <td><img src="uploads/'.$row['image'].'" height="90"></td>
                                     <td><a href="delete.php?id='.$row['id'].'"><i data-feather="delete"><i></a></td>
                                      <td><a href="edit.php?id='.$row['id'].'"><i data-feather="edit"><i></a></td>
                                      <td><a href="select.php?id='.$row['id'].'"><i data-feather="eye"><i></a></td>
